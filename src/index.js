...
document.addEventListener("DOMContentLoaded", UI.renderPage);
...
//     const thisProject = Storage.getTodoApp().getProject(project.textContent);
...
//   } else {
//     // const project = todoApp.getProject(activeProject.textContent);
//     const project = Storage.getTodoApp().getProject(activeProject.textContent);
//     const todos = project.getTodos();
